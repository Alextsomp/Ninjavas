...
public class Main extends Application {
	...
	public void load() { // creates the necessary components
		...
		originComboBox.getItems().addAll("Athens", "Thessaloniki", "Patras", "Ioannina", "Tirana", "Skopje", "Sofia",
				"Podgorica", "Pristina", "Bucharest", "Belgrade", "Sarajevo", "Zagreb", "Chisinau", "Ljubljana");
		...
		originComboBox.setOnAction(e -> {
			...
			if (selectedCity != null) {
				...
				switch (selectedCity) {
					case "Athens":
						c1.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://ipanematravels.com/wp-content/uploads/2023/10/Athens-Greece.jpg"));
						break;
					case "Thessaloniki":
						c2.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://www.letsdrive.gr/sites/default/files/Thessaloniki%20750x500.jpg"));
						break;
					case "Patras":
						c3.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://v9c9u8s9.delivery.rocketcdn.me/wp-content/uploads/2021/09/Upper-town-Patras-.jpg"));
						break;
					case "Ioannina":
						c4.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://www.olympion-rehab.com/cache/files/fb10ef16219a69a5a02cb436efdb5ceda2fd0742.jpg"));
						break;
					case "Tirana":
						c5.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://eia476h758b.exactdn.com/wp-content/uploads/2023/08/Tirana-1.jpg"));
						break;
					case "Skopje":
						c6.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://tripjive.com/wp-content/uploads/2024/07/Is-Skopje-worth-visiting.jpg"));
						break;
					case "Sofia":
						c7.setDisable(true);
						cityImageView.setImage(
								loadCityImage("https://cdn.getyourguide.com/img/tour/5c5424b437891.jpeg/146.jpg"));
						break;
					case "Podgorica":
						c8.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://assets.enuygun.com/media/lib/570x400/uploads/image/podgorica-59036.jpeg"));
						break;
					case "Pristina":
						c9.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://lp-cms-production.imgix.net/2019-06/e228bf3be784ffff7a338ec8d9167d30-pristina.jpg"));
						break;
					case "Bucharest":
						c10.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://www.wanderlustmagazine.com/wp-content/uploads/2023/11/2-palace-of-parliament-at-sunrise-shutterstock_1788823946-web.jpg"));
						break;
					case "Belgrade":
						c11.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://i0.wp.com/mytravelation.com/wp-content/uploads/2023/12/Belgrade-Serbia.jpg"));
						break;
					case "Sarajevo":
						c12.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://web-assets.transavia.com/78ae936f-d39d-01b0-c3ef-dc738304142f/472cea8d-c842-4343-8c2f-1e5ee7f43acd/Sarajevo.jpg"));
						break;
					case "Zagreb":
						c13.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://www.travel.gr/wp-content/uploads/2021/12/zagreb-kentriki-scaled.jpg"));
						break;
					case "Chisinau":
						c14.setDisable(true);
						cityImageView.setImage(
								loadCityImage("https://static.independent.co.uk/2021/09/24/16/iStock-1066138896.jpg"));
						break;
					case "Ljubljana":
						c15.setDisable(true);
						cityImageView.setImage(loadCityImage(
								"https://cdn.britannica.com/79/124479-050-DD359499/Ljubljana-Slovenia.jpg"));
						break;
				}
			}
		});
		...
		submitSelectedCitiesBtn.setOnAction(e -> {
			...
			if (selectedCity != null) {
				...
				if (startCityIndex != -1 && !selectedCitiesList.contains(startCityIndex)) { // Check if the starting
																							// city exists in the list
																							// and is not already added
																							// to the selectedCitiesList
		...
		mainLayout.getChildren().addAll(topContent, nameFields, originCitySelection, cityImageView, textcities, cities,
